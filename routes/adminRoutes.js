...
const { adminDashboard, addProduct, showAddProductForm, showEditProductForm, updateProduct, deleteProduct, upload, getProductImage, viewOrders, updateOrderStatus  } = require("../controllers/adminController");
